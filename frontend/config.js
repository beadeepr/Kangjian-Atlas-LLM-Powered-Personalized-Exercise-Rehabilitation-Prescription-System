...
window.APP_CONFIG = {
  ...
  IMAGING_ALLOWED_FILE_PATTERN: /\.(txt|md|pdf|docx|png|jpe?g)$/i,
  IMAGING_CLIENT_TEXT_FILE_PATTERN: /\.(txt|md)$/i,
  IMAGING_MAX_FILE_BYTES: 5 * 1024 * 1024,
  IMAGING_UPLOAD_TIMEOUT_MS: 35000,
  ...
  POSE_REQUIRED_KEYPOINTS: {
    ...
    lifting_of_arms: [5, 6, 7, 8, 9, 10],
    shoulder_abduction_left: [5, 6, 7, 9],
    shoulder_abduction_right: [5, 6, 8, 10],
    shoulder_flexion_left: [5, 6, 7, 9],
    shoulder_flexion_right: [5, 6, 8, 10],
    shoulder_forward_elevation: [5, 6, 7, 8, 9, 10],
    elbow_flexion_left: [5, 7, 9],
    elbow_flexion_right: [6, 8, 10],
  },
  ...
  POSE_CAMERA_HINTS: {
    ...
    lifting_of_arms: "正面对镜头，确保双肩与双臂完整入镜",
    shoulder_abduction_left: "正面对镜头，确保左肩、左肘、左腕清晰可见",
    shoulder_abduction_right: "正面对镜头，确保右肩、右肘、右腕清晰可见",
    shoulder_flexion_left: "正面对镜头或微侧身，便于观察左臂前屈幅度",
    shoulder_flexion_right: "正面对镜头或微侧身，便于观察右臂前屈幅度",
    shoulder_forward_elevation: "正面对镜头，确保肩肘腕在前屈抬臂时完整入镜",
    elbow_flexion_left: "正面对镜头，确保左肩、左肘、左腕清晰可见",
    elbow_flexion_right: "正面对镜头，确保右肩、右肘、右腕清晰可见",
  },
  isSafeMediaUrl(path) {
...
window.ACTION_CATALOG = {
  ...
  lifting_of_arms: {
    ...
    name: "抬臂",
    description:
      "坐位或站位，双侧手臂同步向上匀速抬起，完整展示上肢整体连贯上抬姿态。抬至肩水平或舒适高度后短暂停留 2–3 秒，再缓慢放下，用于肩肘协调与双侧上肢活动度训练。",
    ...
    videoUrl: "",
    videoHint: "",
    imageHint: "建议：正面图，标出双侧手臂同步向上抬起的连贯轨迹",
  },
  shoulder_abduction_left: {
    id: "shoulder_abduction_left",
    name: "左肩外展",
    description:
      "站位或坐位，左臂从体侧水平向外展开，肩关节向外打开，呈现标准单侧肩外展动作。抬起时避免耸肩代偿，在无痛范围内缓慢还原。",
    ...
    videoUrl: "",
    videoHint: "",
    imageHint: "建议：正面图，标出左臂自体侧水平向外展开的轨迹",
  },
  shoulder_abduction_right: {
    id: "shoulder_abduction_right",
    name: "右肩外展",
    description:
      "站位或坐位，右臂沿身体外侧水平向外平举，肩关节向外延展，展示右侧肩外展活动范围。动作匀速可控，还原时保持肩胛稳定。",
    ...
    videoUrl: "",
    videoHint: "",
    imageHint: "建议：正面图，标出右臂沿体侧水平向外平举的轨迹",
  },
  shoulder_flexion_left: {
    id: "shoulder_flexion_left",
    name: "左肩屈曲",
    description:
      "站位或坐位，左臂沿身体前方向上抬起，肩关节向前弯折，完成单侧肩屈曲康复动作。保持躯干稳定，避免腰部后仰代偿。",
    ...
    videoUrl: "",
    videoHint: "",
    imageHint: "建议：侧面图，标出左臂前向上抬与肩关节前屈弯折角度",
  },
  shoulder_flexion_right: {
    id: "shoulder_flexion_right",
    name: "右肩屈曲",
    description:
      "站位或坐位，右臂向前上方缓慢抬升，肩关节向前弯折，呈现右侧肩屈曲标准活动姿态。抬至舒适高度后缓慢放下，全程控制速度。",
    ...
    videoUrl: "",
    videoHint: "",
    imageHint: "建议：侧面图，标出右臂前向上抬与肩关节前屈弯折角度",
  },
  shoulder_forward_elevation: {
    id: "shoulder_forward_elevation",
    name: "肩前屈",
    description:
      "站位或坐位，单侧手臂整体向前向上抬高，肩部前侧充分伸展，模拟日常抬臂前举动作。动作连贯流畅，可在无痛范围内重复完成。",
    ...
    videoUrl: "",
    videoHint: "",
    imageHint: "建议：侧面图，标出单臂向前向上抬高与肩前侧伸展终末位",
  },
  elbow_flexion_left: {
    id: "elbow_flexion_left",
    name: "左肘屈曲",
    description:
      "坐位或站位，上臂保持不动，左前臂向内弯折收拢，肘关节弯曲使手靠近肩部，展示肘部屈伸活动状态。在无痛范围内缓慢伸直还原。",
    ...
    videoUrl: "",
    videoHint: "",
    imageHint: "建议：侧面图，标出上臂固定与左前臂向内弯折的肘关节角度",
  },
  elbow_flexion_right: {
    id: "elbow_flexion_right",
    name: "右肘屈曲",
    description:
      "坐位或站位，上臂固定不动，右前臂向内弯折收起，肘关节弯曲，呈现单侧屈肘基础动作。弯曲与伸展均缓慢进行，避免借力甩动。",
    ...
    videoUrl: "",
    videoHint: "",
    imageHint: "建议：侧面图，标出上臂固定与右前臂向内弯折的肘关节角度",
  },
  mckenzie_press_up: {
